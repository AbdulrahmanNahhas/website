...
function ShinyButton({ children, onClick, className }: { children: React.ReactNode, className?: string, onClick?: () => void }) {
   return (
      <motion.button
         {...animationProps}
         onClick={onClick}
      ...
      >
         <span
            className={ny("relative block h-full w-full text-sm tracking-wide text-[rgb(0,0,0,65%)] dark:font-light dark:text-[rgb(255,255,255,90%)]", className)}
            style={{
               maskImage:
